...
from tkfontchooser import askfont# Modifications Was Done To Correct Depreciation Warnings For Python 3.12
...
def about():
    ...
    msg3='\nScientific Calculator Created In Python 3.12 64-Bit'
    msg4='\nRevision / Date: 2.4.0 / 10/24/2023'
    msg5='\nCreated For Windows 10/11'
    msg=msg1+msg2+msg3+msg4+msg5
    messagebox.showinfo('About pySci Calculator', msg)
...
def numeric_clicked(event):
    try:
        ...
        if base=='Decimal':
            ...
            elif base=='Binary':value=str(Convert_Base(2,10,str(val2)))
    ...
    try:
        ...
        if not Answer_Err.get():
            ...
            if Answer_Present.get():# Answer Becomes 1st Entry, Operator Becomes Second Entry
                ...
                elif base=='Binary':answer=str(Convert_Base(2,10,str(answer)))
                expr_update(answer)
                expr_update(text)
        return        
    except Exception as e:
